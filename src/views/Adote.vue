<template>
  ...
  <section class="container text-center p-4">
    ...
    <div id = "addCardsPets" class="card-columns">
      <div class="card">
        <img class="card-img-top" src="../assets/dog_example_1.jpg" alt="Imagem de capa do card">
        <div class="card-body">
      ...
      <div class="card">
        <img class="card-img-top" src="../assets/dog_example_2.jpg" alt="Imagem de capa do card">
        <div class="card-body">
          <h5 class="card-title">Título do card</h5>
      ...
      <div class="card">
        <img class="card-img-top" src="../assets/dog_example_3.jpg" alt="Imagem de capa do card">
        <div class="card-body">
          <h5 class="card-title">Título do card</h5>
